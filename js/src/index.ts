...
const render: Render<WidgetModel> = ({ model, el }) => {
    ...
    // download secret configured), the global is absent — show an actionable
    ...
    if (typeof Ogma === "undefined") {
        ...
        el.innerHTML =
            ...
            "Configure a download secret and license, e.g.<br>" +
            "<code>og.set_license(\"&lt;license&gt;\", download=True, " +
            "download_secret=\"&lt;secret&gt;\")</code><br>" +
            "or set the <code>OGMA_DOWNLOAD_SECRET</code> environment variable, " +
