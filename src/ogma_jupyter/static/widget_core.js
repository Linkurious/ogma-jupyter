...
var render = ({ model, el }) => {
  ...
  if (typeof Ogma === "undefined") {
    ...
    el.innerHTML = '<div><strong>Ogma library not loaded.</strong><br>Configure a download secret and license, e.g.<br><code>og.set_license("&lt;license&gt;", download=True, download_secret="&lt;secret&gt;")</code><br>or set the <code>OGMA_DOWNLOAD_SECRET</code> environment variable, then re-run this cell.</div>';
    return;
  }
